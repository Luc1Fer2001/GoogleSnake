...
namespace SmartValues
{
    ...
    public class DependentIntValue
    {
        ...
        public DependentIntValue(List<int> mapping, DependentIntValue dependence)
        {
            _mapper = mapping;
            dependence.OnValueUpdate += ResolveDependency;
            ResolveDependency(dependence.Value);
    ...
    /// Имеет событие обновления переменной
    /// </summary>
    public class InverseDependentIntValue
    {
        private readonly List<int> _mapper;
        ...
        private void ResolveDependency(int value)
        {
            _value = _mapper[value];
            OnValueUpdate?.Invoke(_value.Value);
        }

        public InverseDependentIntValue(List<int> mapping, SavedIntValue dependence)
        {
            _mapper = mapping;
            dependence.OnValueUpdate += ResolveDependency;
            ResolveDependency(dependence.Value);
        }
        public InverseDependentIntValue(List<int> mapping, DependentIntValue dependence)
        {
            _mapper = mapping;
            dependence.OnValueUpdate += ResolveDependency;
            ResolveDependency(dependence.Value);
